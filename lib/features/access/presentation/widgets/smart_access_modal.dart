...
class _SmartAccessModalState extends State<SmartAccessModal> with TickerProviderStateMixin {
      ...
      children: [
          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Icon(PhosphorIconsRegular.caretLeft, size: 20, color: AppColors.deepSlate),
              ),
            ),
            const Text(
              'Mobile Intercom',
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image: const DecorationImage(
              image: NetworkImage('https://images.unsplash.com/photo-1558036117-15d82a90b9b1?auto=format&fit=crop&w=800&q=80'), // Premium upscale lobby
              fit: BoxFit.cover,
            ),
            boxShadow: [
              BoxShadow(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: List.generate(50, (index) => Colors.black.withOpacity(index % 2 == 0 ? 0.08 : 0.0)),
                      ),
                    ),
                  ),
                ),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: const Color(0xFF3B82F6).withOpacity(0.12), width: 1),
          ),
          child: Row(
            children: [
              // Pulser Avatar
                  ...
                  ...List.generate(2, (index) {
                    return AnimatedBuilder(
                      ...
                      builder: (context, child) {
                        final progress = (_pulseController.value + index / 2) % 1.0;
                        return Container(
                          width: 48 + (progress * 24),
                          height: 48 + (progress * 24),
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            color: const Color(0xFF3B82F6).withOpacity(0.2 * (1 - progress)),
                          ),
                        );
                      },
                    );
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(
                        ...
                        errorBuilder: (context, error, stackTrace) => Container(
                          color: const Color(0xFF3B82F6),
                          child: const Icon(PhosphorIconsFill.userCircle, color: Colors.white, size: 28),
                        ),
                      ),
                    ),
                  ),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: AppColors.deepSlate.withOpacity(0.02)),
          ),
          child: Row(
            children: [
              Icon(
                _isMuted ? PhosphorIconsFill.microphoneSlash : PhosphorIconsFill.microphone,
                color: _isMuted ? AppColors.error : const Color(0xFF3B82F6),
                size: 20,
              ),
              const SizedBox(width: 8),
              Expanded(
                child: SliderTheme(
                  data: SliderTheme.of(context).copyWith(
                    ...
                    inactiveTrackColor: AppColors.deepSlate.withOpacity(0.08),
              ...
              const SizedBox(width: 8),
              Icon(
                _volume > 0.5 ? PhosphorIconsFill.speakerHigh : PhosphorIconsFill.speakerLow,
                color: const Color(0xFF3B82F6),
                size: 20,
              ),
            ],
        ...
        Row(
          ...
          children: [
            ...
            _buildCallControlCircle(
              icon: _isSpeakerOn ? PhosphorIconsFill.speakerHigh : PhosphorIconsFill.speakerNone,
              label: 'Speaker',
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              shape: BoxShape.circle,
              border: Border.all(
                color: isActive ? const Color(0xFF3B82F6) : AppColors.deepSlate.withOpacity(0.12),
                width: 1.2,
              ),
              boxShadow: [
                BoxShadow(
                  color: isActive ? const Color(0xFF3B82F6).withOpacity(0.2) : Colors.black.withOpacity(0.03),
                  blurRadius: 8,
                  offset: const Offset(0, 3),
                )
              ]
            ),
            child: Icon(icon, color: isActive ? Colors.white : AppColors.deepSlate, size: 22),
          ),
          const SizedBox(height: 6),
          Text(
            label,
                    ...
                    children: [
                      ...
                      AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: (_isGateUnlocked ? const Color(0xFF10B981) : const Color(0xFF8B5CF6)).withOpacity(0.35),
                              blurRadius: 20,
                              offset: const Offset(0, 8),
                            ),
                          ],
                        ...
                        child: Center(
                          child: AnimatedRotation(
                            ...
                            duration: const Duration(milliseconds: 350),
                            child: Icon(
                              _isGateUnlocked ? PhosphorIconsFill.lockSimpleOpen : PhosphorIconsFill.lockSimple,
                              color: Colors.white,
                              size: 46,
                            ),
                          ),
            ...
            Center(
              child: Text(
                ...
                style: TextStyle(
                  ...
                  fontWeight: _isGateUnlocked ? FontWeight.bold : FontWeight.w500,
                ),
              ),
            ),
                ...
                child: Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: isSelected ? AppColors.deepSlate : AppColors.textSecondary,
                    ),
                  ),
                ),
              ),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(PhosphorIconsFill.qrCode, color: Color(0xFF8B5CF6), size: 22),
          ),
            ...
            child: Column(
              ...
              children: const [
                Text(
                  ...
                  style: TextStyle(fontSize: 13.5, fontWeight: FontWeight.w700, color: AppColors.deepSlate),
                ),
                SizedBox(height: 2),
                Text(
          ...
          const Icon(PhosphorIconsRegular.caretRight, color: Color(0xFF8B5CF6), size: 16),
        ],
      ),
    );
  }
    ...
    return Row(
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            border: Border.all(color: AppColors.deepSlate.withOpacity(0.08), width: 1.5),
          ),
          child: ClipRRect(
            ...
            child: Image.network(
              ...
              errorBuilder: (context, error, stackTrace) => Container(
                ...
                child: const Icon(PhosphorIconsFill.user, color: AppColors.textSecondary, size: 18),
              ),
            ),
          ),
        ),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                name,
                style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: AppColors.deepSlate),
              ),
